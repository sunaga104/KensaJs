...
exports.displayStartMsg = exports.space = exports.decoratLine3 = exports.decoratLine2 = exports.decoratLine = exports.splitLine = exports.allKsTestResultMsg = exports.allResultMsg = exports.resultMsg = exports.successLog = exports.failureLog = exports.failLogo = exports.passLogo = exports.msg = exports.callSubTitle = exports.callTitle = void 0;
const style_1 = require("./style");
function callTitle(msg) {
    console.log('📄', (0, style_1.logStyle)(msg).bold().build());
}
exports.callTitle = callTitle;
function callSubTitle(msg, paragraph, index) {
    const spaces = ' '.repeat(paragraph);
    console.log(spaces, index ? `${index}.` : '', (0, style_1.logStyle)(msg).bold().build());
}
exports.callSubTitle = callSubTitle;
function msg(msg) {
    console.log((0, style_1.logStyle)(msg).bold().build());
}
exports.msg = msg;
...
function failureLog(title, result, expected, paragraph) {
    const spaces = ' '.repeat(paragraph + 1);
    console.log(spaces, (0, style_1.logStyle)('✗').red().bold().build(), '', title, ` (result: ${(0, style_1.logStyle)(String(result)).red().build()}, expected: ${(0, style_1.logStyle)(String(expected))
        .yellow()
        .build()})`);
}
exports.failureLog = failureLog;
function successLog(title, paragraph) {
    const spaces = ' '.repeat(paragraph + 1);
    console.log(spaces, (0, style_1.logStyle)('✓').green().bold().build(), '', title);
}
...
exports.displayStartMsg = displayStartMsg;
